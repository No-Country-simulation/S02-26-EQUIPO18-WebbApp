          ...
          <div key={step.id} className="group flex flex-col items-center">
            ...
            <div className="relative mb-8">
              <CustomImage
                src={step.image}
                alt={step.title}
                containerClass="w-40 h-40 md:w-48 md:h-48 drop-shadow-xl group-hover:scale-110 transition-transform duration-500"
                className="object-contain" // Importante: para que no se corte el diseño 3D
              />
